...
var optionselected=createElement("option")
...
select.append(optionselected,option1,option2,option3)
...
select.append(optionselected,option1,option2,option3,option4,option5)
...
select.setAttribute("class","form-control required")
var selected=createElement("option")
var option1=createElement("option")
var option2=createElement("option")
var option3=createElement("option")
var option4=createElement("option")
...
option4.innerHTML="Drinks"
option5.innerHTML="Salad"
select.append(selected,option1,option2,option3,option4,option5)
...
if(fname==null||fname=="",lname==null||lname=="",gender==null||gender=="",Address==null||Address=="",State==null||State=="",Pincode==null||Pincode=="",country==null||country=="")
{
    alert("fill the Missing Fields")
}else if(FoodChoice1==null||FoodChoice1=="",FoodChoice2==null||FoodChoice2=="") 
{
    alert("FoodChoice1 and FoodChoice2 must be selected")
}
else{
 dataBase.push({
...
+"<td>"+dataBase[i].FName+"</td>"
+"<td>"+dataBase[i].LName+"</td>"
+"<td>"+dataBase[i].Gender+"</td>"
+"<td>"+dataBase[i].Addr+"</td>"
+"<td>"+dataBase[i].State+"</td>"
+"<td>"+dataBase[i].Pin+"</td>"
+"<td>"+dataBase[i].country+"</td>"
+"<td>"+dataBase[i].FC1+"</td>"
+"<td>"+dataBase[i].FC2+"</td>"
+"<td>"+dataBase[i].FC3+"</td>"
+"<td>"+dataBase[i].FC4+"</td>"
+"<td>"+dataBase[i].FC5+"</td>"
+"</tr>")
++i;
}
